...
if(isset($_POST['simpan'])) {
  ...
  $no_urut2= mysqli_real_escape_string($koneksi, $_POST['no_urut2']);
  ...
  if($_POST['simpan']){
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
      if($ukuran <= 2000000){          
        ...
        $query = mysqli_query($koneksi, "INSERT INTO data_paslon2 VALUES(NULL, '$gambar1')");
        ...
        if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
          if($ukuran <= 2000000){          
            ...
            $query = mysqli_query($koneksi, "INSERT INTO data_paslon2 VALUES(NULL, '$gambar2')");
			...
			if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
				...
				$query = mysqli_query($koneksi, "INSERT INTO data_paslon2 VALUES(NULL, '$gambar3')");
          }
        }
          }
        }
  ...
  mysqli_query($koneksi,"INSERT INTO data_paslon2(id, nim_ketua, nm_paslon_ketua, gambar1, no_urut2)
    VALUES ('','$nim_ketua','$nm_paslon_ketua','$gambar1','$no_urut2')");
  
  echo "<script>window.alert('Data Berhasil ditambahkan')
  window.location='input_data_paslon_dpkm'</script>";
...
<body>
  ...
  <div id="page-wrapper" >
    <div id="page-inner">
      <div class="row">
        <div class="col-lg-12">
          <h2><i class="fa fa-user"> Input data Calon</i></h2>   
        </div>
      </div>              
      <!-- /. ROW  -->
        ...
        <div class="col-lg-6">
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" name="no_urut2" required="required" class="form-control">
            </div>
            <div class="form-group">
            ...
            <div class="col-lg-12">
              ...
              <div class="table-responsiv">
                <table class="table table-striped table-bordered table-hover">
                  ...
                  <?php
                  $data_paslon = mysqli_query($koneksi,"SELECT * FROM data_dpkm");
                  while($d = mysqli_fetch_array($data_paslon)){
                    ?>
                    <tr>
                      <td><?php echo $d['nm_paslon_ketua']; ?></td>
					  
                      <td><?php echo $d['no_urut2']; ?></td>
                      <td><a class="btn btn-danger btn-circle" onclick="return confirm('Yakin hapus data ini !!!')" href="hapus.php?no_urut2=<?php echo $d['no_urut2']; ?>">Hapus</a>
                      </td>
                    </tr>
                  <?php } ?>
                </table>
