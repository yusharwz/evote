...
if(isset($_POST['simpan'])) {
  ...
  if($_POST['simpan']){
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
      if($ukuran <= 2000000){          
        ...
        $query = mysqli_query($koneksi, "INSERT INTO data_fpik VALUES(NULL, '$gambar1')");
        ...
        if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
          if($ukuran <= 2000000){          
            ...
            $query = mysqli_query($koneksi, "INSERT INTO data_fpik VALUES(NULL, '$gambar2')");
			...
			if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
				...
				$query = mysqli_query($koneksi, "INSERT INTO data_fpik VALUES(NULL, '$gambar3')");
          }
        }
          }
        }
  ...
  mysqli_query($koneksi,"INSERT INTO data_fpik(id, nim_ketua, nm_paslon_ketua, gambar1, nim_wakil, nm_paslon_wakil, gambar2, gambar3,no_urut)
  ...
  window.location='input_data_paslon_fpik'</script>";
