            ...
            <div class="sidebar-collapse">
                <div class="menu">
                  <ul class="nav" id="main-menu">
                      ...
                      <li>
                          <a href="../sistem/index"><i class="fa fa-desktop"></i>Beranda</a>
                      </li>
                      <?php
            ...
            <div id="page-inner">
              ...
              <div class="row">
                <div class="col-lg-6">
                    ...
                    ?>
                    <form action="aksi_upload_dpt" method="post" enctype="multipart/form-data">
                      ...
                      <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover">
                          <tr>
                            ...
                            <?php
                              $data_dpt = mysqli_query($koneksi,"SELECT * FROM tbl_dpt WHERE status2='Belum memilih'");
                          ...
                          <tr>
                              ...
                              <td><a class="btn btn-danger btn-circle" onclick="return confirm('Yakin hapus data ini !!!')" href="hapus?no_urut=<?php echo $d['no_urut']; ?>">Hapus</a>
                              </td>
                          </tr>
                            <?php } ?>
                        </table>
                        ...
                        <h3>Data DPT sudah memilih</h3>
                          ...
                          <table class="table table-striped table-bordered table-hover">
                            <tr>
                              ...
                              <?php
                                $data_dpt = mysqli_query($koneksi,"SELECT * FROM tbl_dpt WHERE status2='(Sudah memilih)'");
                                while($d = mysqli_fetch_array($data_dpt)){
                              ?>
                            <tr>
                                <td><?php echo $d['nim']; ?></td>
