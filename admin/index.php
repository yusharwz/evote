...
if(isset($_POST['simpan'])) {
  ...
  $cek = mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM tbl_login WHERE nim='$nim'"));
  if ($cek > 0){
    echo"<script>window.alert('Anda sudah menggunakan hak suara, tidak bisa melakukan voting lagi')
    window.location='../sistem/selesai'</script>";
        }
        else {
          ...
          if ($fakultas == 1){
            mysqli_query($koneksi,"INSERT INTO tbl_abstain_fpik(nim)
              VALUES ('$nim')");
            ...
            if ($fakultas1 == 1){
              mysqli_query($koneksi,"INSERT INTO tbl_abstain_fp(nim)
                VALUES ('$nim')");
              ...
              if ($fakultas2 == 1){
                mysqli_query($koneksi,"INSERT INTO tbl_abstain_fapet(nim)
                  VALUES ('$nim')");
        ...
        <div class="sidebar-collapse">
          <div class="menu">
            <ul class="nav" id="main-menu">
             ...
             <!--<img src="../images/ub1.png" alt="Bangka Cendekia" style="width:10px;"> <br>
              -->
            ...
            <div class="col-lg-12">
             <div class="alert alert-success">
              <div class="row">
                ...
                <h2="center"><b>Klik 'MASUK' pada tombol dibawah untuk masuk ke Halaman Vote Ketua dan Wakil Ketua EKM Fakultas </b></h2><br>
                  <h2="center"><b>*saat masuk ke halaman vote, anda diberi waktu 30 detik untuk menentukan paslon yang akan dipilih</b></h2><br>
