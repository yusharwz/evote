...
<body>
  ...
  <div id="page-wrapper" >
    <div id="page-inner">
      <div class="row">
        <div class="col-lg-12">
          <h2><i class="fa fa-chart"> Hasil Suara Pres dan Wapres</i></h2>   
        </div>
      </div>
	  <!-- /. ROW  -->
          ...
          var myChart = new Chart(ctx, {
            ...
            data: {
              ...
              datasets: [{
                ...
                data: [
                <?php 
                $paslon1 = mysqli_query($koneksi,"select * from tbl_ekm where nomor_paslon='1'");
                echo mysqli_num_rows($paslon1);
                ?>, 
                <?php 
                $paslon2 = mysqli_query($koneksi,"select * from tbl_ekm where nomor_paslon='2'");
