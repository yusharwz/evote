...
<body>
  ...
  <div id="page-wrapper" >
    <div id="page-inner">
      <div class="row">
        <div class="col-lg-12">
          <h2><i class="fa fa-chart"> Hasil Suara DPKM</i></h2>   
        </div>
      </div>
	  <!-- /. ROW  -->
      ...
      <div style="width: 800px;margin: 0px auto;">
        ...
        <script>
          ...
          var myChart = new Chart(ctx, {
            type: 'bar',
            data: {
              labels: ["DPKM 1", "DPKM 2", "DPKM 3"],
              datasets: [{
                label: 'Jumlah Suara',
                data: [ 
                <?php 
                $paslon1 = mysqli_query($koneksi,"select * from tbl_dpkm where nomor_paslon2='1'");
                echo mysqli_num_rows($paslon1);
                ?>,
                <?php 
                $paslon2 = mysqli_query($koneksi,"select * from tbl_dpkm where nomor_paslon2='2'");
                echo mysqli_num_rows($paslon2);
                ?>,
                <?php 
                $paslon3 = mysqli_query($koneksi,"select * from tbl_dpkm where nomor_paslon2='3'");
