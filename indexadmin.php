...
if(isset($_POST['login'])){
	...
	$data_akses = mysqli_query($koneksi, "SELECT * FROM tbl_akses_admin INNER JOIN tbl_admin ON tbl_akses_admin.nim = tbl_admin.nim WHERE kode_akses='$kode_akses'");
					...
					<div class="container-login100">
						<div class="wrap-login100">
							...
							<form class="login100-form validate-form" action="" method="post">
								...
								<img src="images/ub1.png" alt="Bangka Cendekia" style="width:80px;"> <br>
