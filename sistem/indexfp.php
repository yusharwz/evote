...
if(isset($_POST['simpan'])) {
  ...
  $cek = mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM tbl_fp WHERE nim='$nim'"));
  if ($cek > 0){
    echo"<script>window.alert('Anda tidak bisa melakukan voting lagi')
          ...
          mysqli_query($koneksi,"INSERT INTO tbl_fp(nim, nomor_paslon)
