...
if(isset($_POST['simpan'])) {
  ...
  $cek = mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM tbl_ekm WHERE nim='$nim'"));
  $cek1 = mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM tbl_abstain_ekm WHERE nim='$nim'"));
  if ($cek > 0){
    echo"<script>window.alert('Anda tidak bisa melakukan voting lagi')
          window.location='indexdpkm'</script>";
        }
  if ($cek1 > 0){
    echo"<script>window.alert('Anda tidak bisa melakukan voting lagi')
          window.location='indexdpkm'</script>";
          ...
          mysqli_query($koneksi,"INSERT INTO tbl_ekm(nim, nomor_paslon)
          ...
          <div class="row">
            <div class="col-lg-12">
             <div class="alert alert-success">
              <div class="row">
                <div class="col-lg-12">
                  <h2 align="center"><b>CALON PRESIDEN DAN WAKIL PRESIDEN</b></h2><br>
                  <form action="" method="post">
                    <?php
                    $data_paslon = mysqli_query($koneksi,"SELECT * FROM data_ekm");
