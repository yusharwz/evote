...
if(isset($_POST['simpan'])) {
  ...
  $nomor_paslon2 =$_POST['nomor_paslon2'];

  
  $cek = mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM tbl_dpkm WHERE nim='$nim'"));
  $cek1 = mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM tbl_abstain_dpkm WHERE nim='$nim'"));
  ...
  if ($cek1 > 0){
    echo"<script>window.alert('Anda tidak bisa melakukan voting lagi !')
          ...
          mysqli_query($koneksi, "UPDATE tbl_dpt SET status='(Sudah Memilih)', waktu2='$waktu2' WHERE nim='$nim'");
          mysqli_query($koneksi,"INSERT INTO tbl_dpkm(nim, nomor_paslon2)
            VALUES ('$nim','$nomor_paslon2')");
          ...
          <div class="menu">
            <ul class="nav" id="main-menu">
              ...
              if($level){
                ...
                <li>
                  <a href="upload_dpt"><i class="fa fa-file"></i>Daftar Pemilih Tetap Pres dan Wapres</a>
                </li>

                <li>
                  <a href="upload_dpt2"><i class="fa fa-file"></i>Daftar Pemilih Tetap DPKM</a>
                </li>
          ...
          <h3><b>Waktu Pilih <span id ="countdown">30</span></b></h3>
            <div class="col-lg-12">
             <div class="alert alert-success">
              <div class="row">
                <div class="col-lg-12">
                  <h2 align="center"><b>CALON ANGGOTA DPKM</b></h2><br>
                  <form action="" method="post">
                    <?php
                    $data_paslon2 = mysqli_query($koneksi,"SELECT * FROM data_dpkm");
                    while($d = mysqli_fetch_array($data_paslon2)){
                      ?>
                      <div class="col-lg-6">
                        <table class="table table-striped table-bordered table-hover">
                          <tr>
                            <td colspan="2" style="background-color: #000961; color: white; font-size: 50px; text-align: center;"><b><?php echo $d['no_urut2']; ?></b>
                            </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td colspan="2" style="text-align: center; padding: 20px; background-color: #000961;"><input type="radio" style="width:25px;height:25px;background:#000961;" required="required" name="nomor_paslon2" value="<?php echo $d['no_urut2']; ?>"></td>
                          </tr>
                        </table>
                      </div>
                    <?php } ?>
