...
if(isset($_POST['simpan'])) {
  ...
  $cek = mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM tbl_fapet WHERE nim='$nim'"));
  if ($cek > 0){
    echo"<script>window.alert('Anda tidak bisa melakukan voting lagi')
          ...
          mysqli_query($koneksi,"INSERT INTO tbl_fapet(nim, nomor_paslon)
