...
if(isset($_POST['simpan'])) {
  ...
  $cek2 = mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM tbl_paslon2 WHERE nim='$nim'"));
  ...
  if ($cek2 > 0){
    echo"<script>window.alert('Anda tidak bisa melakukan voting lagi !')
          ...
          echo"<script> window.location='indexdpkm'</script>";
        }
      }
      ?>
      <!DOCTYPE html>
          ...
          <div class="menu">
            <ul class="nav" id="main-menu">
              ...
              if($level){
                ...
                <li>
                  <a href="hasil_suara"><i class="fa fa-chart-bar"></i>Hasil Suara </a>
                </li>
          ...
          <div class="row">
            <div class="col-lg-12">
             <div class="alert alert-success">
              <div class="row">
                <div class="col-lg-12">
                  <h2="center"><b>Klik 'LANJUTKAN' pada tombol dibawah untuk masuk ke Halaman Vote Anggota DPKM</b></h2><br>
                  <h5><b>Otomatis pindah dalam <span id ="countdown">5</span></b></h5>
...
if ($gusmint > $wes){
	echo"
        <input style='color: white; font-size: 20px; padding: 10px; border-radius: 15px; width: 100%;' type='submit' name='simpan' value='LANJUTKAN' class='btn btn-success' onclick='return confirm('YAKIN DENGAN PILIHAN ANDA')' disabled>
...
elseif ($gusmint >= $cendekia){
	echo"
        <input style='color: white; font-size: 20px; padding: 10px; border-radius: 15px; width: 100%;' type='submit' name='simpan' value='LANJUTKAN' class='btn btn-success' onclick='return confirm('YAKIN DENGAN PILIHAN ANDA')'>
        ";
}
else{
	echo"
