  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Reset Password</p>
				...
				$select=mysql_query("SELECT email,kode_akses FROM tbl_akses WHERE email='$email' AND md5(kode_akses)='$pass'");
     ...
     <form action="" method="POST">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="kode_akses" class="form-control" name="kode_akses" id="kode_akses" onkeyup='check();' placeholder="*********">
...
if(isset($_POST['submit_password']))
{
  ...
  $select=mysql_query("UPDATE tbl_akses SET kode_akses='$pass' WHERE email='$email'") or die(mysql_error());
    if($select){
        echo "<script> alert('Reset password berhasil'); window.location = 'index.php'; </script>";//jika pesan terkirim
	    
    }else{
    echo "<script>alert('Gagal Menyimpan '); window.location = 'reset_pass.php';</script>";
     }
}
?>
    </div>
